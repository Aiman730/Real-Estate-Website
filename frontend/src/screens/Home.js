            ...
            <div style={styles.reviewsContainer}>
                ...
                <div style={styles.reviewCard}>
                    ...
                    <p style={styles.reviewText}>
                        aaaaaaaaaabbbbbbccccvvvvvvvvvdddddddddddddddddd
                    </p>
                </div>
                ...
                <div style={styles.reviewCard}>
                    <img src="https://via.placeholder.com/50" alt="Client" style={styles.clientImage} />
                    <p style={styles.clientName}>Anum Farooq</p>
